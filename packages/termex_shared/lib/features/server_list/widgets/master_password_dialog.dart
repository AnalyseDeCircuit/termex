...
class _MasterPasswordDialogState extends ConsumerState<MasterPasswordDialog> {
  ...
  Widget build(BuildContext context) {
    // Render as a popup-style modal: dimmed full-screen backdrop with a
    // centered, bordered card on top — not a full-screen page.
    return Stack(
      children: [
        // Semi-transparent backdrop. The barrier color matches
        // [showTermexDialog] so the visual language is consistent.
