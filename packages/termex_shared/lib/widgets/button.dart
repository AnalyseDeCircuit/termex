...
class TermexIconButton extends StatefulWidget {
  ...
  /// Override the container's corner radius. Defaults to [TermexRadius.md].
  /// Pass [BorderRadius.zero] for square-cornered buttons (e.g. the tab-bar
  /// "+" button which sits flush with the tab cards).
          ...
          child: MouseRegion(
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: effectiveBg,
                  borderRadius: widget.borderRadius ?? TermexRadius.md,
                  border: border,
                ),
                alignment: Alignment.center,
                child: widget.icon,
