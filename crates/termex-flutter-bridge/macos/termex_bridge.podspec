#
# Flutter FFI plugin podspec for termex_bridge (macOS).
# Builds the termex_flutter_bridge Rust crate via cargokit.
#
Pod::Spec.new do |s|
  s.name             = 'termex_bridge'
  s.version          = '0.53.7'
  s.summary          = 'FRB-generated bindings for termex-core (macOS).'
  s.description      = <<-DESC
Flutter FFI plugin that bundles the termex_flutter_bridge Rust crate.
  ...
  s.frameworks = ['SystemConfiguration', 'Security', 'CoreFoundation', 'CoreServices']
  s.libraries  = ['resolv', 'z', 'iconv']
